...
class DitandaiPage extends StatelessWidget {
        ...
        child: Column(
          children: [
            ...
            const TabBar(
              ...
              tabs: [
                Tab(text: 'Telah Ditandai'),
                Tab(text: 'Telah Dilihat'),
              ],
            ),
            Divider(
              height: 1,
            ...
            Expanded(
              child: TabBarView(
                children: [
                  ...
                  const Center(child: Text('Pernah Dilihat Kos List')),
                ],
              ),
            ),
          ],
